      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              <Video className="text-[#039744] w-6 h-6 mr-1" />
              Book a call
            </Button>
            <Link href="#contact">
              <Button
                size="sm"
                className="w-full bg-[#039744] hover:bg-[#039744] text-white rounded-full px-4 py-2"
              >
                Get in touch
              </Button>
            </Link>
          ...
          {teamMembers.map((member) => (
            ...
            >
              <div className="relative overflow-hidden rounded-lg bg-gray-200 aspect-[4/5] hover:shadow-lg transition-all duration-300">
                ...
                <div className="absolute bottom-3 left-3 right-3 bg-white/80 backdrop-blur-sm border group-hover:border-[#FFCA0B] border-white/20 rounded-lg p-3">
